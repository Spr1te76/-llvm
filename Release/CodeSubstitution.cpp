...
// 混淆次数，混淆次数越多混淆结果越复杂
static cl::opt<int> ObfuTime2("sub_loop", cl::init(1), cl::desc("Obfuscate a function <obfu_time> time(s)."));
...
FunctionPass* llvm::createCodeSubstitution(){
